...
> Build an intelligent support system that remembers customer history and provides personalized help
...
<Tabs>
  <Tab title="Next.js">
    ```typescript lib/customer-context.ts theme={null}
  ...
  <Tab title="Python">
    ```python customer_context.py theme={null}
...
<Tabs>
  <Tab title="Next.js API Route">
    ```typescript app/api/support/chat/route.ts theme={null}
  ...
  <Tab title="Python FastAPI">
    ```python support_api.py theme={null}
...
```tsx app/support/page.tsx theme={null}
'use client'
