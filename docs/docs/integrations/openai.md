...
<CodeGroup>
  ...
  ```typescript JavaScript/TypeScript SDK theme={null}
...
<CodeGroup>
  ```python Python Configuration theme={null}
  ...
  ```typescript JavaScript Configuration theme={null}
...
<CodeGroup>
  ```python Python Individual Tools theme={null}
  ...
  ```typescript JavaScript Individual Tools theme={null}
  import {
...
<CodeGroup>
  ```python Complete Python Example theme={null}
  import asyncio
  import openai
  from supermemory_openai import SupermemoryTools, execute_memory_tool_calls
  ...
  ```typescript Complete JavaScript Example theme={null}
  import OpenAI from "openai"
...
<CodeGroup>
  ...
  ```typescript JavaScript Error Handling theme={null}
  import OpenAI from "openai"
